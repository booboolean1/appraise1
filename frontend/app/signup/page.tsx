...
import { Eye, EyeOff, Home, Mail, Lock, ArrowRight, Sparkles, UserPlus } from 'lucide-react';
          ...
          <div className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50 shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Start your journey to a fair appraisal.</p>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-gray-800/50 border-gray-600/50 text-white placeholder-gray-400 focus:border-orange-500/50 focus:ring-orange-500/20 transition-all duration-300 pl-4 pr-12 py-3 rounded-xl"
                      required
                    />
                    <button
                      type="button"
